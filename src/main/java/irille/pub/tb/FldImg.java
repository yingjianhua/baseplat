...
import irille.pub.view.VFldImg;
 ...
 * @version 1.0
 */
public class FldImg<T extends FldImg> extends Fld<T> {
	private short _width;
	private int _len; // 长度
	/**
	 * 构造方法
	 */
	public FldImg(String code, String name,int len,boolean null1) {
		super(code,name);
		_len=len;
		_width=(short)len;
		setNull(null1);
  ...
  public T copyNew( String code, String name) {
		return (T)copy(new FldImg(code,name,_len,isNull()));
  }
	@Override
